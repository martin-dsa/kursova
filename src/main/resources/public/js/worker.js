...
app.controller("AppCtrl", function ($scope, $http) {
    ...
    $scope.create = function () {
        ...
        $http.get('/api/worker/insert?startingPoint=' + st_point + '&finalPoint=' + fn_point +
    ...
    $scope.update = function () {
        ...
        $http.get('/api/worker/insert?id=' + id + '&startingPoint=' + st_point + '&finalPoint=' + fn_point +
            '&transferPoint=' + tr_point + '&ticketPrice=' + tck_price + '&type=' + type + '&time=' + time).then(function (response) {
            window.location.reload();
        });
    };
    ...
    $scope.delete = function () {
        $http.get('/api/worker/delete?id=' + id).then(function (response) {
            window.location.reload();
        });
    };
});